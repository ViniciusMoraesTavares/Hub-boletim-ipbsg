...
export const quizQuestions: QuizQuestion[] = [
  // ---- Fáceis ----
  {
    ...
    options: ['Gênesis 22', 'Salmo 23', 'João 3', '2 Reis 4', 'Oséias 11'],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ['“Habito no meio do meu povo”', '“Quero um filho”', '“Desejo honra pública”', '“Preciso de riquezas”', '“Peço cura para meu marido”'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['Viúva com muitos filhos', 'Solteira e próspera', 'Separada e sem recursos', 'Casada com filhos pequenos', 'Casada sem filhos, marido idoso'],
    correctAnswer: 4,
  ...
  // ---- Médias ----
  {
    ...
    options: ['Contentamento depende de possuir tudo', 'Contentamento é agradecer pelo que se tem e não lamentar o que não se recebeu', 'Contentamento exige ausência total de problemas', 'Contentamento ignora a realidade', 'Contentamento é resignação amarga'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Excesso de oração', 'Excesso de trabalho', 'Busca por conhecimento bíblico', 'Vida comunitária intensa', 'Incapacidade de contar as bênçãos de Deus'],
    correctAnswer: 4,
  ...
  },
  {
    ...
    options: ['Ela não apresenta pedidos, mesmo sem filhos e com marido idoso', 'Ela exige herdeiros imediatamente', 'Ela reclama da sua sorte', 'Ela pede riqueza e status', 'Ela abandona sua fé'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['Prosperidade garante plenitude', 'Falta de recursos gera contentamento', 'A comunidade resolve todo problema', 'O vazio humano não é suprido por posses', 'A solução é mais consumo religioso'],
    correctAnswer: 3,
  ...
  // ---- Difíceis ----
  {
    ...
    options: ['Apego a status social', 'Confissão de pertença e gratidão pela provisão divina na comunidade', 'Indiferença às promessas de Deus', 'Isolamento espiritual como ideal', 'Busca por recompensa profética'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Aponta que apenas Deus preenche o vazio humano', 'Defende nihilismo', 'Propõe ascetismo extremo', 'Afirma suficiência das riquezas', 'Nega valor da comunidade'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['Evitar a vida comunitária', 'Fixar-se nas carências e reclamar', 'Buscar soluções exclusivamente materiais', 'Comparar-se constantemente aos outros', 'Agradecer pelo que Deus já deu, contar as bênçãos e viver contente'],
    correctAnswer: 4,
  ...
  },
  {
    ...
    options: ['É obstáculo espiritual', 'É mera formalidade social', 'É irrelevante', 'É substituto de Deus', 'É expressão do cuidado de Deus percebido e valorizado'],
    correctAnswer: 4,
